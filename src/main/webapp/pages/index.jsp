...
<div class="header-main">
    <div class="authorizationBox">
        ...
        <div class = "content">
            <input class="login-input" type="text center" placeholder="Логин" name = "login" required id="login"></p>
            <input class="login-input" type="password" placeholder="Пароль" name = "password" required id="password"></p>
        </div>
        <div class = "center">
